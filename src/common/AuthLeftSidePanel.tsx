export default function AuthLeftSidePanel() {
	return (
		<div className="font-['Plus_Jakarta_Sans'] h-screen w-[64%] border p-12 bg-linear-to-br from-zinc-950 via-indigo-900 to-indigo-700 flex flex-col justify-between items-start">
